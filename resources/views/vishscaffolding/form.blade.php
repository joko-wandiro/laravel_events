...
<div class="dk-section-form-elements">
    ...
    ?>
	<?php
	// Hook Action afterFormFields
	$Scaffolding->doHooks("afterFormFields", array($Scaffolding));
	?>
	<div class="row" id="form-action-buttons">
	    <div class="form-group">
	        <div class="col-sm-12">
	            <button type="submit" class="btn btn-save btn-blue"><?php echo $submit; ?></button>
	            <a href="<?php echo $Scaffolding->getFormAction(); ?>" class="btn btn-cancel btn-white"><?php echo $cancel; ?></a>
	        </div>
	    </div>
	</div>
</div>
